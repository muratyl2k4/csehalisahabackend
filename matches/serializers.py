...
class PlayerMatchStatsSerializer(serializers.ModelSerializer):
    """Oyuncu maç istatistikleri serializer"""
...
class MatchDetailSerializer(serializers.ModelSerializer):
    """Maç detay için serializer - oyuncu istatistikleri ile"""
    ...
    def get_team1_players(self, obj):
        """Takım 1 oyuncularının istatistiklerini getir"""
    ...
    def get_team2_players(self, obj):
        """Takım 2 oyuncularının istatistiklerini getir"""
        stats = PlayerMatchStats.objects.filter(
            match=obj,
            team=obj.team2
        ).select_related('player')
...
class PlayerMatchHistorySerializer(serializers.ModelSerializer):
    """Oyuncu maç geçmişi için serializer"""
