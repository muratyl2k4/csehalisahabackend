...
class PlayerViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        """
        List ve Retrieve herkese açık.
        Create, Update, Destroy sadece Adminlere açık.
        (Normal kullanıcılar kendi profillerini 'me' endpoint'i ile yönetir)
        """
    ...
    def get_queryset(self):
        ...
        # Sadece e-postası doğrulanmış oyuncuları göster
        if self.action == 'list':
    ...
    def me(self, request):
        ...
        GET /api/players/me/ -> Profil detaylarını döner
        PUT/PATCH /api/players/me/ -> Profili günceller
        """
        try:
    ...
    def verify_forgot_password_code(self, request):
        """
        Şifre sıfırlama kodunu doğrular (şifreyi değiştirmeden).
    ...
    def forgot_password(self, request):
        """
        Şifre sıfırlama için kod gönderir.
