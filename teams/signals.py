...
def notify_on_transfer_request_update(sender, instance, created, **kwargs):
    """
    TransferRequest oluşturulduğunda veya güncellendiğinde bildirim gönderir.
    """
    
    # 1. New Request -> Notify Captain
    if created:
        team = instance.team
    ...
    # 2. Request Status Changed (Accepted/Rejected) -> Notify Player
    else:
